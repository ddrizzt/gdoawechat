...
if [ ! -d "/mnt/apps/tools/jdk1.8.0_101/" ]; then
	...
	#For Beijing QCloud deploy please use these below urls.
...
#	cd /mnt/apps/tools/ && wget -q "https://gdwechat-bj-1252063756.cos.ap-beijing.myqcloud.com/wechatoa_package/jce_policy-8.zip"
	...
	cd /mnt/apps/tools/ && wget -q "https://gdwechat-1252063756.cos.na-siliconvalley.myqcloud.com/wechatoa_package/apache-maven-3.3.9-bin.tar.gz"
	cd /mnt/apps/tools/ && wget -q "https://gdwechat-1252063756.cos.na-siliconvalley.myqcloud.com/wechatoa_package/jdk-8u101-linux-x64.gz"
	cd /mnt/apps/tools/ && wget -q "https://gdwechat-1252063756.cos.na-siliconvalley.myqcloud.com/wechatoa_package/jce_policy-8.zip"
